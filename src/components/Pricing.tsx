...
const plans = [
  {
    ...
    features: [
      'Half of a full size basketball/volleyball court',
      'Nets and training equipment included',
      'Weight training ',
      'Use of concessions',
    ],
  ...
  },
  {
    ...
    features: [
      'All half court amenities included',
      'Full size basketball/volleyball court',
      'Ability to host events or tournaments',
      'Game clocks',
    ],
