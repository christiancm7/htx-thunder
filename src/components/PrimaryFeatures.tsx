...
const features = [
  {
    ...
    description:
      'Our facility takes pride in offering state-of-the-art basketball courts that set the stage for unforgettable gameplay, complemented by an array of premium training equipment including cones, balls, and rebound machines.',
    icon: BasketballIcon,
    screen: InviteScreen,
  },
  {
    ...
    description:
      'Step onto our professional-grade volleyball courts, where the quality of play is elevated by top-tier nets, ensuring every serve and spike is met with the precision and durability.',
    icon: VolleyballIcon,
    screen: StocksScreen,
  },
  {
    name: 'Tournaments and Camps',
    description:
      'Join the excitement of our tournaments and camps, where athletes of all levels unite for the love of the game, train hard, and compete with heart, all while building personal skills and team spirit.',
    icon: TrophyIcon,
    screen: InvestScreen,
  },
]
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(props.animated ? headerAnimation : {})}>
        ...
        <AppScreen.Subtitle>March 9, 2025</AppScreen.Subtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody
        {...(props.animated ? { ...bodyAnimation, custom: props.custom } : {})}
      >
